    ...
    <section> 
      ...
      <ul>
        <li className="card">
            <div className="card__main">
                <div className="card__inner">
                    <p classNmae="card__name"><span>OUR</span> COUNTRY</p>
                    <p className="card__total card card__small">INDIA</p>
                </div>
            </div>
        </li>
        ...
        <li className="card">
            <div className="card__main">
                <div className="card__inner">
                    <p classNmae="card__name"><span>Total</span> RECOVERED</p>
                    <p className="card__total card card__small">{data.recovered}</p>
                </div>
            </div>
        </li>
        ...
        <li className="card">
            <div className="card__main">
                <div className="card__inner">
                    <p classNmae="card__name"><span>Total</span> DEATHS</p>
                    <p className="card__total card card__small">{data.deaths}</p>
                </div>
            </div>
        </li>
